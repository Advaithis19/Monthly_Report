    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_staff', models.BooleanField(default=False, verbose_name='is this user of staff type?')),
                ('is_active', models.BooleanField(default=True, verbose_name='is this user active?')),
                ('is_teacher', models.BooleanField(default=False, verbose_name='is this user a teacher?')),
                ('is_admin', models.BooleanField(default=False, verbose_name='is this user an admin(HoD/Faculty-admin)?')),
                ('is_superadmin', models.BooleanField(default=False, verbose_name='is this user a super admin(Principal/Dean)?')),
