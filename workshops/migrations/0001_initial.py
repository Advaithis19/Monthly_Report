    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_name', models.CharField(max_length=50, unique=True, verbose_name='name of event')),
                ...
                ('f_id', models.ManyToManyField(related_name='workshops_faculty_involved', to=settings.AUTH_USER_MODEL, verbose_name='faculty involved')),
            ],
            options={
                'db_table': 'workshop',
                'ordering': ('-date_added',),
